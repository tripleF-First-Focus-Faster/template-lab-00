 ...
 * parallel in , parallel out
 ...
 1. Used in central processing units and microcontrollers
 2. Digital communication and Port interfaces 
 3. Digital clocks , Timers and Smart appliances 
 4. Elecronic Displays 
 5. Computer Memory 


 # conclusion 

 flip-flops provide the temppral synchronization necessary to turn electrical currents into orderly 1s and 0s , then registers scale up this behaviour by enabling holding of vomplex byte-level sequence of zeros and ones . this behaviour contribute heavily in modern computing environment .
